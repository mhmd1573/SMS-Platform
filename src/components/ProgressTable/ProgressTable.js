        ...
        <tbody>
          {data.map((row, index) => (
            <tr key={index}>
              ...
              <td><ProgressCell value={row.deliveredTotal} max={1000} colorVariant={getProgressColor(row.deliveredTotal)} /></td>
              <td><ProgressCell value={row.deliveredwSuccess} max={1000} colorVariant={getProgressColor(row.deliveredwSuccess)} /></td>
              <td><ProgressCell value={row.deliveredwPartialSuccess} max={1000} colorVariant={getProgressColor(row.deliveredwPartialSuccess)} /></td>
              <td><ProgressCell value={row.deliveredwDelay} max={1000} colorVariant={getProgressColor(row.deliveredwDelay)} /></td>
              <td><ProgressCell value={row.deliveredwError} max={1000} colorVariant={getProgressColor(row.deliveredwError)} /></td>
